...
public:
    ...
    {
       any meaning;
       while (_data[_current_pos]!='{'&& _data[_current_pos]!='['&&_data[_current_pos]!='\"'&&(_data[_current_pos]<='0'||_data[_current_pos]>='9')&&_data[_current_pos]!='t'&&_data[_current_pos]!='f')
       {
           _current_pos++;
       }
       ...
       if (_data[_current_pos]=='{')
       {
           ...
           if ((_data.find(",",_current_pos)<_data.find("}",_current_pos+1))&&(_data.find("}",_current_pos+1)!=string::npos))
           {
               while (_data[_current_pos]!=',')
               {
                   _current_pos++;
       ...
       if (_data[_current_pos]=='[')
       {
           ...
           meaning=tmp.parse();
           _current_pos+=tmp._current_pos;
           if ((_data.find(",",_current_pos)<_data.find("]",_current_pos+1))&&(_data.find(",",_current_pos)!=string::npos))
           {
               while (_data[_current_pos]!=',')
               {
                   _current_pos++;
